...
def index(request, *args, **kwargs):
    ...
    if kwargs:
        ...
        base_url = '/' # /
    #blog = models.Article.objects.filter(article_type_id=article_type_id).select_related('blog').first()
    ...
    page_str = page_obj.page_str(base_url)  #反回之后就是一个个a标签
...
def home(request,site):
    ...
    博主个人首页
    :param request:
    :param site:   博主的网站后缀如：http://xxx.com/zhichao.html
    :return:
    """
