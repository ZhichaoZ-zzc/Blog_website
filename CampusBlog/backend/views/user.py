...
@check_login
def index(request):
    return render(request, 'back_web/backend_index.html')
...
def base_info(request):
    ...
    :return:
    """
    return render(request, 'back_web/backend_base_info.html')
...
def tag(request):
    ...
    :return:
    """
    return render(request, 'back_web/backend_tag.html')
...
def category(request):
    ...
    :return:
    """
    return render(request, 'back_web/backend_category.html')
...
def add_article(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'back_web/backend_add_article.html', {'form': form})
...
def edit_article(request, nid):
    ...
    if request.method == 'GET':
        ...
        if not obj:
            return render(request, 'back_web/backend_no_article.html')
        ...
        return render(request, 'back_web/backend_edit_article.html', {'form': form, 'nid': nid})
